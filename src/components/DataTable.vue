  ...
  <div :class="theme.row">
    ...
    <div :class="theme.table.colClasses">
      <div :class="theme.table.tableContainer">
        ...
        <table
          :class="theme.table.tableClasses"
          :id="tableId"
        >
          <thead>
            <tr>
              ...
              >
                ...
                >
                  ...
                  <template v-if="column.orderable">
                    <template v-if="defaultOrder[0] !== null && defaultOrder[0] === headerIndex">
                      <i
...
export default {
  ...
  methods: {
    ...
    requestLocalData (page) {
      ...
      if (this.defaultOrder) { this.rows = recordFiltered.slice(this.start * this.length, (this.start * this.length) + parseInt(this.length)) }
    ...
    initStates () {
      if (this.savedState) {
        const { length, search, page, start, defaultOrder, recordsTotal, recordsFiltered } = getDataTableState(this.tableId)
